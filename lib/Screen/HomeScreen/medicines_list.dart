...
import 'package:meddico/Screen/HomeScreen/medicine_card.dart';
...
class MedicinesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemBuilder: (context, index) => Medicine_Card(listOfMedicines[index],setData,flutterLocalNotificationsPlugin),
